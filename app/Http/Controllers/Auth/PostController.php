...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->precio==0 or $request->precio==1) {
         return redirect()->back()->with(['status'=>'error', 'msg'=>'Por favor, ingrese un precio mayor a ( 0 o 1)', 'operation_notif'=>'ERROR EL PRECIO NO PUEDE SER 0 o 1']);
        }
    ...
    {   
        ...
        $imagenes = $post->postimagenes()->get();
    ...
    public function update(Request $request)
    {
        ...
        $publicacion->precios = $request->precio;
