            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-8 col-lg-6">
                        @if(setting('site.de'))
                            @if($total>setting('site.monto_minimo'))
                            <div class="col-12 m-auto col-md-8 col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <a class="btn btn-info" href="/compartir/{{$carrito->id}}/pedido">Compartir este Pedido<i class="ps-icon-next"></i></a>
                                    </div>
                                </div>
                            </div>
                            @else
                                <span class="w-100 mx-auto btn btn-primary">La compra minima es de ${{setting('site.monto_minimo')}}</span>
                            @endif
                        @else
