            ...
            <div class="col-12 col-lg-8 col-xl-9 py-5">
                ...
                <div class="row g-3 mt-2">
                    @foreach($interesados as $consulta)
                      <div class="col-12 remove{{$consulta->id}}">
                          <div class="card">
                              <div class="card-body">
                                  ...
                                  <h5 class="card-title">Tu consulta: {{$consulta->mensaje}}</h5>
                                  <h5 class="card-title">Respuesta: @if($consulta->answered) <b class="btn btn-success">{{$consulta->answered}}</b> @else <b class ="btn btn-info">Sin respuesta aun @endif</b></h5>
