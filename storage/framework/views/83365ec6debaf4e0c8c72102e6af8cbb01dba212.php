        ...
        <div class="card-body">
            ...
            <section class="fs-5 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h6 class="mb-4">
                            Tu pregunta: <a href="#" class="link-success"><?php echo e($question); ?></a>
                        </h6>
                        <h6 class="mb-4">
                            La respuesta que recibiste: <a href="#" class="link-success"><?php echo e($answer); ?></a>
                        </h6>
                    </div>
...
</html><?php /**PATH /var/www/html/terminados/nuevo/looktucuman/resources/views/emails/answer.blade.php ENDPATH**/ ?>