            ...
            <div class="col-12 col-lg-8 col-xl-9 py-5">
                <div class="grid rows-2 rows-lg-1 cols-1 cols-lg-2 justify-content-stretch align-items-center">
                    <div class="grid-item p-0 justify-self-center justify-self-lg-start">
                        <h2 class="m-0">Tus preguntas realizadas</h2>
                    </div>
                </div>
                ...
                <div class="row g-3 mt-2">
                    <?php $__currentLoopData = $interesados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $consulta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="col-12 remove<?php echo e($consulta->id); ?>">
                          <div class="card">
                              <div class="card-body">
                                  ...
                                  <h5 class="card-title">Tu consulta: <?php echo e($consulta->mensaje); ?></h5>
                                  <h5 class="card-title">Respuesta: <?php if($consulta->answered): ?> <b class="btn btn-success"><?php echo e($consulta->answered); ?></b> <?php else: ?> <b class ="btn btn-info">Sin respuesta aun <?php endif; ?></b></h5>
                                  <?php /*<div class="my-3 form-floating">
                                      <textarea type="text" maxlength="255" class="form-control" id="input_answer{{$consulta->id}}" placeholder="Ejemplo" style="height: 120px;"></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/terminados/nuevo/looktucuman/resources/views/auth/intereses/index.blade.php ENDPATH**/ ?>