                ...
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <?php
                                $dataTypeRows = $dataType->{($edit ? 'editRows' : 'addRows' )};
                                $exclude = ['title', 'body', 'excerpt', 'slug', 'status', 'category_id', 'author_id', 'featured', 'image', 'subcategoryId', 'modelo_id', 'marca_id'];
                            ?>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            <?php if(isset($dataTypeContent->marca_id)): ?>
                $.post("/admin/lista_modelos", { _token: "<?php echo e(csrf_token()); ?>" , modelo_id:<?php if($dataTypeContent->modelo_id): ?><?php echo e($dataTypeContent->modelo_id); ?><?php else: ?> 0 <?php endif; ?>, elegido: <?php echo e($dataTypeContent->marca_id); ?> }, function(data){
                    $("#modelo_id").html(data);
                }); 
            <?php endif; ?>
        });
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/terminados/nuevo/looktucuman/vendor/tcg/voyager/src/../resources/views/posts/edit-add.blade.php ENDPATH**/ ?>