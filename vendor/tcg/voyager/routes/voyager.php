...
Route::group(['as' => 'voyager.'], function () {
    ...
    Route::group(['middleware' => 'admin.user'], function () use ($namespacePrefix) {
        ...
        Route::get('price-update', $namespacePrefix.'VoyagerPostController@priceupdate');
        Route::post('massiveupdateprice', ['uses' => $namespacePrefix.'VoyagerPostController@massiveupdateprice', 'as' => 'massiveupdateprice']);
        Route::get('/truncate/price-update', $namespacePrefix.'VoyagerPostController@truncatepriceupdate');
        
        Route::post('posts/{id}/changueprice', $namespacePrefix.'VoyagerPostController@changueprice');
        Route::post('posts/changue_status', $namespacePrefix.'VoyagerPostController@changue_status');
        Route::get('posts/{id}/etiqueta', $namespacePrefix.'VoyagerPostController@etiqueta');
        Route::get('posts/printslabels', $namespacePrefix.'VoyagerPostController@printslabels');
        Route::post('posts/etiquetas', $namespacePrefix.'VoyagerPostController@etiquetas');
