...
class Voyager
{
    ...
    public function get_image($img, $tipo_crop)
    {   
    ...
    public function h_listview($title, $id, $imagen, $storage, $precios, $cropp_type, $prd_catname)
    {
        return view('shared.prd_listview', compact('title', 'id', 'imagen', 'storage', 'precios', 'cropp_type', 'prd_catname'));
    }

    public function returnDescuento($precio, $descuento)
    {
        $n1 =  intval($descuento);
        $n2 = intval($precio);
    ...
    public function return_total($precio, $cantidad)
    {
        $n1 = $precio;
        $n2 = $cantidad;
        return  ($n1 * $n2);
